                ...
                <CardContent>
                    ...
                    {preview && (
                        <div className="space-y-4">
                            ...
                            <Button className="w-full" onClick={onSend} disabled={sending || !isConfigured}>
                                {sending && <Icons.AppLogo className="mr-2 h-4 w-4 animate-spin" />}
                                {sending ? 'Sending...' : 'Send Real Email'}
                            </Button>
                             {!isConfigured && <p className="text-xs text-center text-destructive">Sending is disabled until configured.</p>}
                        </div>
                    )}
                </CardContent>
            </Card>

  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Mobile positioning: anchor to bottom, full width
        "bottom-0 left-0 right-0 rounded-t-[1.25rem]",
        // Mobile animation: slide in from bottom / out to bottom
    ...
    >
      ...
      <div className="sm:hidden absolute top-2 left-1/2 -translate-x-1/2 w-10 h-1 rounded-full bg-muted-foreground/30" aria-hidden="true" />
      {children}

...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl md:text-5xl font-bold font-headline text-foreground tracking-tighter animate-in fade-in slide-in-from-bottom-2 duration-1000">Dashboard</h1>
